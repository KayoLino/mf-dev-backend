...
namespace mf_dev_backend.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        [AllowAnonymous] //Acessando de forma anonima
        ...
        public async Task<IActionResult> Login(Usuario usuario)
        {
            ...
            if (senhaOk)
            {
                ...
                {
                    new Claim(ClaimTypes.Name, dados.Nome), //Nome
                     new Claim(ClaimTypes.NameIdentifier, dados.Id.ToString()), //Id
                      new Claim(ClaimTypes.Role, dados.Perfil.ToString()) //Perfil
                };
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Senha,Perfil")] Usuario usuario)
        {
            ...
            {
                usuario.Senha = BCrypt.Net.BCrypt.HashPassword(usuario.Senha); //Criptografando a senha
